...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/qt5/plugins/platformthemes/libmatsyaplatformtheme.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/qt5/plugins/platformthemes/libmatsyaplatformtheme.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/lib/x86_64-linux-gnu/qt5/plugins/platformthemes/libmatsyaplatformtheme.so")
...
file(INSTALL DESTINATION "/usr/lib/x86_64-linux-gnu/qt5/plugins/platformthemes" TYPE MODULE FILES "/home/tokyo/clone/cuteclone/qt-plugins/build/platformtheme/libmatsyaplatformtheme.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/qt5/plugins/platformthemes/libmatsyaplatformtheme.so" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/qt5/plugins/platformthemes/libmatsyaplatformtheme.so")
    endif()
  endif()
endif()
