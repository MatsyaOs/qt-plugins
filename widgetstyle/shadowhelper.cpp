...
const char netWMSkipShadow[] = "_MATSYA_NET_WM_SKIP_SHADOW";
const char netWMForceShadow[] = "_MATSYA_NET_WM_FORCE_SHADOW";
const char netWMFrameRadius[] = "_MATSYA_NET_WM_FRAME_RADIUS";
